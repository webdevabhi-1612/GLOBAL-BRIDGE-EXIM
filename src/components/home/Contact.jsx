      ...
      <section id="contact" className="w-full bg-white py-24 px-6 md:px-12 lg:px-20 font-sans relative z-10 border-t border-gray-100">
        <div className="max-w-[1200px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-start">
          ...
          <div className="w-full flex flex-col gap-8">
             <div className="w-full h-[400px] lg:h-[450px] rounded-[2rem] overflow-hidden shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 group relative">
                {/* 
                  EXACT FIX: 
                  Using strict GPS coordinates (19.086417, 74.737278) with standard output=embed.
                  This guarantees the red marker drops exactly on the building.
                */}
                <iframe 
                  width="100%" 
                  height="100%" 
                  frameBorder="0" 
                  src="https://maps.google.com/maps?q=19.086417,74.737278&t=m&z=17&output=embed&iwloc=near"
                  title="Global Bridge Exim Location"
                  className="grayscale-[10%] transition-all duration-700 group-hover:grayscale-0 absolute inset-0"
                ></iframe>
             </div>
             ...
             <div className="flex flex-col sm:flex-row justify-between gap-8 px-2">
               <div>
                 ...
                 <p className="text-[#4A5D53] leading-relaxed text-[15px] font-medium">
                   <span className="font-bold text-[#0C3B24]">Global Bridge Exim</span><br />
                   265, B-Wing, Ambar Plaza,<br />
                   Station Road, Ahilyanagar,<br />
